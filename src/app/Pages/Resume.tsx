...
export default function Resume() {
    return (
        <div>
            <div className="p-4 flex flex-col items-center leading-6">
                <h1 className="text-5xl font-bold pb-2">Matthew Creek</h1>
                <h3 className="text-xl pb-2 font-semibold">Software engineer in St. Louis, MO</h3>
            ...
            <div className='m-2 flex justify-around'>
                <div className='w-2/3 p-2 flex flex-col'>
                    <div>
                        <h2 className='font-bold'>PROJECT EXPERIENCE</h2>
                        <p><span className='font-bold'>Recipe Hive</span> -- ReactJS with Java Spring Boot SQL Database (LC101 Capstone Project)</p>
                    ...
                    <div>
                        ...
                        <p><span className='font-bold'>Studio Manager</span> -- Shock City Studios, St. Louis, MO</p>
                    ...
                    <div>
                        ...
                        <p><span className='font-bold'>LaunchCode,</span> LC101 Programming Course -- 2023</p>
                        <p><span className='font-bold'>Webster University,</span> BFA, Audio Engineering -- 2013</p>
                    </div>
                </div>
                <div className='w-1/3 p-2 flex flex-col'>
                    <div>
                        <h2 className='pb-2 font-bold'>SKILLS</h2>
                        <div>
                    ...
                    <div>
                        ...
                        <div>
                            <h3 className='font-bold'>Better Business Bureau&apos;s Torch Award (2016 & 2021)</h3>
